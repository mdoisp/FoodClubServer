...
import { GetRestaurantByIdService } from '../../../application/use-cases/restaurant/get-restaurant-byid.service'
import { CreateRestaurantService } from '../../../application/use-cases/restaurant/create-restaurant.service';
import { UpdateRestaurantService } from '../../../application/use-cases/restaurant/update-restaurant.service';
import { DeleteRestaurantService } from '../../../application/use-cases/restaurant/delete-restaurant.service';
...
export class RestaurantController {
  ...
  async getById(@Param('id') id: string, @Res() res: Response): Promise<Restaurant> {
  ...
  create(
    @Body() restaurant: Restaurant, @Res() res: Response) {
  ...
  async update(@Param('id') id: string, @Body() restaurantData: Restaurant,@Res() res: Response): Promise<Restaurant> {
