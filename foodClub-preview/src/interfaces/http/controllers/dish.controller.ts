...
import { GetDishByIdService } from '../../../application/use-cases/dish/get-dish-byid.service';
import { CreateDishService } from '../../../application/use-cases/dish/create-dish.service';
import { UpdateDishService } from '../../../application/use-cases/dish/update-dish.service';
import { DeleteDishService } from '../../../application/use-cases/dish/delete-dish.service';
import { Response } from 'express';
import { DishEntityInterface } from 'src/infrastructure/database/interfaces/dish.interface';
import { ListDishesService } from '../../../application/use-cases/dish/list-dishes.service';
...
export class DishController {
  ...
  async getById(@Param('id') id: string, @Res() res: Response): Promise<Dish> {
  ...
  create(
    @Body() dish: Dish, @Res() res: Response) {
  ...
  async update(@Param('id') id: string, @Body() dishData: Dish, @Res() res: Response): Promise<Dish> {
