...
import { GetEmployeeByIdService } from '../../../application/use-cases/employee/get-employee-byid.service';
import { CreateEmployeeService } from '../../../application/use-cases/employee/create-employee.service';
import { UpdateEmployeeService } from '../../../application/use-cases/employee/update-employee.service';
import { DeleteEmployeeService } from '../../../application/use-cases/employee/delete-employee.service';
import { Response } from 'express';
import { EmployeeEntityInterface } from 'src/infrastructure/database/interfaces/employee.interface';
import { ListEmployeesService } from '../../../application/use-cases/employee/list-employees.service';
...
export class EmployeeController {
  ...
  create(
    @Body() employee: Employee, @Res() res: Response) {
  ...
  async update(@Param('id') id: string, @Body() employeeData: Employee, @Res() res:Response): Promise<Employee> {
