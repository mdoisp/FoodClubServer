...
import { GetCompanyByIdService } from '../../../application/use-cases/company/get-company-byid.service'
import { CreateCompanyService } from '../../../application/use-cases/company/create-company.service';
import { UpdateCompanyService } from '../../../application/use-cases/company/update-company.service';
import { DeleteCompanyService } from '../../../application/use-cases/company/delete-company.service';
import { Response } from 'express';
import { CompanyEntityInterface } from 'src/infrastructure/database/interfaces/company.interface';
import { ListCompaniesService } from '../../../application/use-cases/company/list-companies.service';
...
export class CompanyController {
  ...
  create(
    @Body() company: Company, @Res() res: Response) {
  ...
  async update(@Param('id') id: string, @Body() companyData: Company, @Res() res: Response): Promise<Company> {
